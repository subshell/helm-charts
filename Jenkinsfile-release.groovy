...
pipeline {
    ...
    parameters {
        ...
        choice(name: 'HelmChart', choices: ['o-neko', 'sophora-repo-import', 'sophora-indexing-service', 'sophora-dashboard', 'sophora-importer', 'sophora-image-access-service', 'sophora-image-update-service', 'sophora-server', 'deskclient-downloads', 'sophora-webclient', 'subshell-technology-radar', 'sophora-export-job', 'sophora-export-cronjob', 'courier', 'sophora-indexer'], description: 'What helm chart to release')
