...
pipeline {
    ...
    parameters {
        ...
        choice(name: 'HelmChart', choices: ['o-neko', 'sophora-repo-import', 'sophora-indexing-service', 'sophora-dashboard-old', 'sophora-importer', 'sophora-image-service', 'sophora-server', 'deskclient-downloads', 'sophora-webclient', 'subshell-technology-radar', 'sophora-export-job', 'sophora-export-cronjob'], description: 'What helm chart to release')
