...
pipeline {
    ...
    parameters {
        choice(name: 'HelmChart', choices: ['o-neko', 'sophora-repo-import', 'sophora-indexing-service', 'sophora-dashboard-old', 'sophora-importer', 'sophora-server', 'sophora-updatesite', 'sophora-webclient'], description: 'What helm chart to release')
